...
const bodySchema = z.object({
  ...
  // device-aware copy ("Code from your Mac" vs generic fallback).
  // Constrained to a known set so we don't
  ...
  platform: z.literal("macos").optional(),
});
...
export async function POST(req: Request): Promise<Response> {
  ...
  // platform tag lets /link render "Code from your Mac" without a DB
  // lookup or schema migration — it just rides along on the URL the app
  // shows the user.
