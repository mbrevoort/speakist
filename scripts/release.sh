...
#    persists in the final compressed DMG. Coordinates here MUST
#    match the layout assumed by scripts/generate-dmg-background.swift
#    so the icons land on top of their ghost outlines in the bg art.
osascript <<APPLE_SCRIPT
tell application "Finder"
    tell disk "$VOL_NAME"
        open
