        ...
        <article className="container max-w-3xl py-16 sm:py-24">
          ...
          <div className="space-y-10 text-base leading-relaxed text-foreground/90">
            ...
            <Section title="Information we collect">
              <P>
                <strong>Account information.</strong> An account is optional.
                When you create one for Speakist Cloud, we collect your email address. You can optionally
                provide a display name. We use a magic-link sign-in flow,
                so we don&apos;t store passwords.
              </P>
              <P>
                <strong>Cloud usage metadata.</strong> Each time you complete a
                Speakist Cloud transcription, we record:
              </P>
              <UL>
